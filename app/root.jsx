...
export function ErrorBoundary() {
  ...
  if (isRouteErrorResponse(error)) {
    switch (error.status) {
      case 404:
        ...
        message =
          "We're sorry, but the page you're looking for doesn't exist yet. We're working on it!";
        break;
      case 401:
      ...
      case 500:
        ...
        message =
          "Our server encountered a problem. Our team has been notified.";
        break;
      default:
  ...
  return (
    <Document title={title}>
      <Navbar />
      <main
        className="flex-grow flex flex-col justify-center items-center px-4 py-16 text-center"
        role="main"
        aria-labelledby="error-heading"
      >
        <h1
          id="error-heading"
          className="text-4xl font-bold text-[#03346E]"
          tabIndex="-1"
        >
          {heading}
        </h1>
        <p className="text-lg mt-4 max-w-lg">{message}</p>
        <p className="mt-6">
          <Link
            to="/"
      ...
      <footer
        className="bg-gray-50 p-4 mt-auto border-t border-gray-200 text-center"
        role="contentinfo"
      >
